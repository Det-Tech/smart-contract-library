...
abstract contract WithdrawalSplittable is Ownable, ReentrancyGuard {
    ...
    receive() external payable {}
     ...
     modifier checkWithdrawalBasisPoints(address[] calldata _wallets, uint256[] calldata _basisPoints) {
    ...
    function setBeneficiaries(address[] calldata _wallets, uint256[] calldata _basisPoints) 
        public 
        onlyOwner 
